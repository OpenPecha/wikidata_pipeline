...
from wiki_utils.wikisource.etext_upload import (
    get_page_titles,
    log_upload_result,
    parse_text_file,
)
...
class TestETextUpload(unittest.TestCase):
    ...
    @patch("wiki_utils.wikisource.etext_upload.os.path.exists")
    @patch("wiki_utils.wikisource.etext_upload.json.load")
    @patch("wiki_utils.wikisource.etext_upload.open")
    ...
    @patch("wiki_utils.wikisource.etext_upload.csv.writer")
    @patch("wiki_utils.wikisource.etext_upload.os.path.isfile")
    @patch("wiki_utils.wikisource.etext_upload.open")
